import { checkIfUserExists, createUser, applyUserUpdate, verifyUserCredentials, updateUserOTP, validateOTP, } from '../models/userModel.js';
...
export const updatePassword = async (req, res) => {
    ...
    console.log('VALS', email, passwordChangeOtp);
    try {
        const user = await findUserByEmail(email);
